      ...
      <tr>
        <td width="180" height="574" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <td width="610" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFF4D4">
			  ...
			  $query=mysql_query("select * from car_list where id_mobil='$_GET[id_mobil]'");
			  while($row=mysql_fetch_array($query)){
			  $id=$row["0"];
			  echo"<form action='sewa-mobil-edit-database.php' method='post' enctype='multipart/form-data'>";
			   ...
			   ?></td>
                    ...
                    <tr>
                      <td width="17" height="20">&nbsp;</td>
                        ...
                        <td colspan="2" align="left" valign="middle"><label>
                          <? echo"<input name='nama_mobil' type='text' class='side-left-desc' id='nama_mobil' size='50' value='$row[1]'/>"; ?>
                        </label></td>
                      </tr>
                    <tr>
                      <td height="20">&nbsp;</td>
                        ...
                        <td colspan="2" rowspan="2" align="left" valign="top"><label>
                          <? echo"<textarea name='spesifikasi' cols='40' rows='7' class='side-left-desc' id='spesifikasi'>$row[3]'</textarea>"; ?>
                        </label></td>
                      </tr>
                    <tr>
                      <td height="74"></td>
                    ...
                    <tr>
                      <td height="20"></td>
                        ...
                        <td align="center" valign="middle">:</td>
                        <td colspan="2" align="left" valign="middle"><label>
                          <? echo"<input name='harga_sewa_tanpa_sopir' type='text' class='side-left-desc' id='harga_sewa_tanpa_sopir' size='50' value='$row[4]'/>"; ?>
                        </label></td>
                      </tr>
                    <tr>
                      <td height="20"></td>
                    ...
                    <tr>
                      ...
                      <td align="center" valign="middle">:</td>
                      <td colspan="2" align="left" valign="middle"><label>
                       <? echo"<input name='harga_sewa_dengan_sopir_max_2hari_dgn_bensin' type='text' class='side-left-desc' id='harga_sewa_dengan_sopir_max_2hari_dgn_bensin' size='50' value='$row[5]'/>"; ?>
                      </label></td>
                    </tr>
                    <tr>
                      <td height="20"></td>
                      ...
                      <td align="center" valign="middle">:</td>
                      <td colspan="2" align="left" valign="middle"><label>
                       <? echo"<input name='harga_sewa_dengan_sopir_diatas_2hari_dgn_bensin' type='text' class='side-left-desc' id='harga_sewa_dengan_sopir_diatas_2hari_dgn_bensin' size='50' value='$row[6]'/>"; ?>
                      </label></td>
                    </tr>
                    <tr>
                      <td height="20"></td>
                      ...
                      <td align="center" valign="middle">:</td>
                      <td colspan="2" align="left" valign="middle"><label>
                       <? echo"<input name='biaya_overtime_dgn_bensin' type='text' class='side-left-desc' id='biaya_overtime_dgn_bensin' size='50' value='$row[9]'/>"; ?>
                      </label></td>
                    </tr>
                    <tr>
                      <td height="20"></td>
                    ...
                    <tr>
                      ...
                      <td align="center" valign="middle">:</td>
                      <td colspan="2" align="left" valign="middle"><label>
                       <? echo"<input name='harga_sewa_dengan_sopir_max_2hari_tanpa_bensin' type='text' class='side-left-desc' id='harga_sewa_dengan_sopir_max_2hari_tanpa_bensin' size='50' value='$row[7]'/>"; ?>
                      </label></td>
                    </tr>
                    <tr>
                      <td height="20"></td>
                      <td align="left" valign="middle">Sewa Dengan Sopir diatas 2 Hari</td>
                      <td align="center" valign="middle">:</td>
                      <td colspan="2" align="left" valign="middle"><? echo"
					  <input name='harga_sewa_dengan_sopir_diatas_2hari_tanpa_bensin' type='text' class='side-left-desc' id='harga_sewa_dengan_sopir_diatas_2hari_tanpa_bensin' size='50' value='$row[8]' />"; ?></td>
                    </tr>
                    <tr>
                      <td height="20"></td>
                      <td align="left" valign="middle">Biaya Overtime </td>
					  ...
					  <? echo"
					  <input name='biaya_overtime_tanpa_bensin' type='text' class='side-left-desc' id='biaya_overtime_tanpa_bensin' size='50' value='$row[10]' />"; ?></td>
                    </tr>
                    <tr>
                      <td height="20"></td>
                    ...
                    <tr>
                      ...
                      <td colspan="2" align="left" valign="middle">
					  <? echo"
					  <input name='status' type='text' class='side-left-desc' id='status' size='50' value='$row[11]' />"; ?></td>
                    </tr>
                    <tr>
                      <td height="21"></td>
                      <td align="left" valign="middle" class="side-left-desc">Gambar 1 </td>
                        ...
                        <td colspan="2" align="left" valign="middle"><label>
                          <? echo"<input name='gambar1' type='file' class='side-left-desc' id='gambar1' size='40' />"; ?>
                        </label></td>
                      </tr>
                    <tr>
                      <td height="21"></td>
                      ...
                      <td align="center" valign="middle" class="side-left-desc">:</td>
                      <td colspan="2" align="left" valign="middle">
					  <? echo"<input name='gambar2' type='file' class='side-left-desc' id='gambar2' size='40' />"; ?></td>
                    </tr>
                    <tr>
                      <td height="25"></td>
                      <td>&nbsp;</td>
