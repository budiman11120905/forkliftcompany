...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFE181">
  ...
  <tr>
        ...
        <td width="180" height="292" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <td width="610" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFF4D4">
            ...
            <tr>
			  ...
			  $no=1;
			  echo"<table border='0' width='99%' cellspacing='1'><tr bgcolor='#FFD96A'><td><b>No</b></td><td><b>Judul dan Deskripsi Tempat Wisata</b></td><td><b>Gambar</b></td><td><b>Action</b></td></tr>";
			  ...
			  echo"<tr bgcolor='$warna'><td valign='top' align='center' width='25'>$no</td><td width='300' valign='top'><b>$row[1]</b><br>";
	...
	echo"................<i><font color='red'>More hide</font></i>";
			  echo"</td><td width='150' valign='top'><img src='../../images/$row[3]' width='150'><br><br><img src='../../images/$row[4]' width='150'></td><td valign='top' width='70'><div class='menuactionadmin'><a href='tempat-wisata-di-bali-insert.php'><b>Insert</b></a></div><div class='menuactionadmin'><a href='tempat-wisata-di-bali-edit.php?id_wisata_bali=$row[0]'><b>Edit</b></a></div><div class='menuactionadmin'><b><a href='tempat-wisata-di-bali-delete.php?id_wisata_bali=$row[0]&file_wisata_bali=$row[5]&file_wisata_bali2=$row[6]' onClick=\"return confirm('Anda yakin ingin menghapusnya?')\">Delete</b></div></td></tr>";
			  $no++;
			  }
