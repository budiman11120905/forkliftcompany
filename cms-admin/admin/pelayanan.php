          ...
          <td width="610" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFF4D4">
            ...
            <tr>
              <td height="235" align="left" valign="top" class="side-left-desc"><br />
                <?
			  $query=mysql_query("select * from pelayanan order by id_pelayanan ASC");
			  $no=1;
			  echo"<table border='0' width='99%' cellspacing='1'><tr bgcolor='#FFD96A'><td><b>No</b></td><td><b>Judul Layanan</b></td><td><b>Deskripsi Layanan</b></td><td><b>Action</b></td></tr>";
			  ...
			  echo"<tr bgcolor='$warna'><td valign='top' align='center'>$no</td><td width='200' valign='top'>$row[1]</td><td width='300' valign='top'>$row[2]</td><td valign='top'><div class='menuactionadmin'><a href='pelayanan-insert.php'><b>Insert</b></a></div><div class='menuactionadmin'><a href='pelayanan-edit.php?id_pelayanan=$row[0]'><b>Edit</b></a></div><div class='menuactionadmin'><b><a href='pelayanan-delete.php?id_pelayanan=$row[0]&file_pelayanan=$row[4]' onClick=\"return confirm('Anda yakin ingin menghapusnya?')\">Delete</b></div></td></tr>";
			  $no++;
			  }
