      ...
      <tr>
        <td width="180" height="292" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <td width="610" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFF4D4">
            ...
            <tr>
              <td height="235" valign="top"><form action="aturan-sewa-mobil-insert-database.php" method="post" enctype="multipart/form-data"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="side-left-desc">
                <!--DWLayoutTable-->
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left" valign="middle"><label>
                    <input name="jenis_sewa" type="text" class="side-left-desc" id="jenis_sewa" size="50" />
                  </label></td>
                </tr>
                <tr>
                  <td height="25"></td>
