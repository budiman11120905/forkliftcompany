          ...
          <td width="610" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFF4D4">
            ...
            <tr>
              <td height="235" align="left" valign="top" class="side-left-desc"><br />
                <?
			  $query=mysql_query("select * from wisatabali where id_wisata_bali='$_GET[id_wisata_bali]'");
			  while($row=mysql_fetch_array($query)){
			  $id=$row["0"];
			  echo"<form method='post' action='tempat-wisata-di-bali-edit-database.php' enctype='multipart/form-data'><table border='0'><tr><td valign='top' width='100'><b>Judul</b></td><td align='center' width='10' valign='top'><b>:</b></td><td><input type='text' name='judul' size='50' class='side-left-desc' value='$row[1]'></td></tr><tr><td valign='top' width='100'><b>Deskripsi</b></td><td align='center' width='10' valign='top'><b>:</b></td><td><textarea name='deskripsi' cols='70' rows='12' class='side-left-desc'>$row[2]</textarea></td></tr><tr><td valign='top' width='100'><b>Gambar 1</b></td><td align='center' width='10' valign='top'><b>:</b></td><td><input type='file' name='gambar1' size='50' class='side-left-desc'></td></tr><tr><td valign='top' width='100'><b>Gambar 2</b></td><td align='center' width='10' valign='top'><b>:</b></td><td><input type='file' size='50' name='gambar2' class='side-left-desc'></td></tr><tr><td colspan='2'></td><td><input type='submit' value='Simpan' class='side-left-desc'><input type='hidden' value='$id' name='id'></td></tr></table></form>";
			  }
			  ?></td>
              </tr>
