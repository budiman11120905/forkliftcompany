      ...
      <tr>
        <td width="180" height="292" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <td width="610" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFF4D4">
            ...
            <tr>
              <td height="252" align="left" valign="top" class="side-left-desc"><br />
                <?
			  $query=mysql_query("select * from userlogin where username='$_SESSION[usernamesession]'");
			  while($row=mysql_fetch_array($query)){
			  echo"<img src='../../images/$row[4]' border='0' align='left' hspace='10'>";
			  
			  ?>
                Hai <b><? echo"$_SESSION[usernamesession]</b>"; ?>, silahkan klik menu pilihan yang berada di sebelah kiri untuk mengelola content website.<br />
                <br />                <? 
			  echo"Nama : <b>$row[5]</b><br>Alamat : <b>$row[6]</b><br>Email : <b><a href='mailto:$row[7]'>$row[7]</a></b><br>";
			  } ?></td>
              </tr>
