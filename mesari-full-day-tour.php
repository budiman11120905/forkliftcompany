    ...
    <td width="800" height="749" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFF7D8">
      ...
      <tr>
        ...
        <td width="566" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <!--DWLayoutTable-->
              <tr>
                <td width="566" height="30" align="left" valign="middle" class="title">Mesari Transport Tour - Full Day Bali Tour </td>
              </tr>
          </table></td>
        ...
        <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			echo"<table width='566' border='0'>";
			  echo"<a name='$row[6]' id='$row[6]'></a><tr><td><img src='paket-wisata/$row[3]' border='0' align='$rata' hspace='8'><font size='2'><b>$row[1]</b></font><br><br>$row[2]</td></tr>";
			  echo"</table><br><hr color='orange'>";
			  $no++;
			  }
			  ?></td>
              </tr>
          <tr>
            <td height="123" align="left" valign="top" class="content-center"><strong>Layanan Full Day Bali Tour sudah termasuk :
              </strong><br />
              <br />
              1. Termasuk dengan AC Mobil
              <br />
              2. Tiket Masuk, tiket hiburan, dan ketika datang ke candi saroong
              <br />
              3. Makan siang dan Makan malam
              <br />
              4. Pelayanan Gratis </td>
              </tr>
