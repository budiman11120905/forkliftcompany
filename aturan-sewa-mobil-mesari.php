...
<title>JMB Forklift | Rental dan Sewa Forklift CV. Jaya Makmur Bersama</title>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr>
    <td width="800" height="681" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFF7D8">
      <!--DWLayoutTable-->
      <tr>
        <td width="210" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="15" height="306" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <!--DWLayoutTable-->
              <tr>
        ...
        <td width="566" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <!--DWLayoutTable-->
              <tr>
                <td width="566" height="30" align="left" valign="middle" class="title">Aturan dan Kondisi Sewa Mobil Mesari Transport Tour </td>
              </tr>
          </table></td>
          <td width="15" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <!--DWLayoutTable-->
              <tr>
                <td width="15" height="581">&nbsp;</td>
              </tr>
          </table></td>
        </tr>
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
          <tr>
            <td width="566" height="469" valign="top" class="content"><br />
              <?
			  include('koneksi-web/koneksi.php');
			  $query=mysql_query("select * from aturan where jenis_sewa='sendiri'");
			  $no=1;
			echo"<table width='566' border='0'><tr><td colspan='2'><b>Sewa Mobil Setir sendiri (self drive)</b><br><br></td></tr>";
			  while($row=mysql_fetch_array($query)){
			  echo"<tr><td valign='top'><b>$no.</b> </td><td>$row[1]</td></tr>";
			  $no++;
			  }
			  echo"</table><br><hr><br>";
			  $query=mysql_query("select * from aturan where jenis_sewa='sopir'");
			  $no=1;
			echo"<table width='555' border='0'><tr><td colspan='2'><b>Sewa mobil dengan sopir.</b><br><br></td></tr>";
			  while($row=mysql_fetch_array($query)){
			  echo"<tr><td valign='top'><b>$no.</b> </td><td>$row[1]</td></tr>";
			  $no++;
			  }
