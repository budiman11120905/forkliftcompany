...
Jakarta Selatan - Indonesia  </td>
          ...
          <td width="566" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <!--DWLayoutTable-->
              <tr>
                <td width="566" height="30" align="left" valign="middle"><h1><b>Kantor Cabang Bogor</b></h1>
...
<img id="sliderImage1"
src='images/kcbogor.jpg'>
        <div class="slidertitle" id="title1">Kantor Cabang Bogor</div>
    
<img id="sliderImage2"
src='images/kcbogor.jpg'>
        <div class="slidertitle" id="title2">Kantor Cabang Bogor</div>
    
<img id="sliderImage3"
src='images/kcbogor.jpg'>
        <div class="slidertitle" id="title3">Kantor Cabang Bogor</div>
      ...
      <tr>
        <td height="739">&nbsp;</td>
          <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="566" height="64" valign="top" class="content"><span class="style1">Alamat Kantor Cabang Bogor</span>.<br />
                Jl.Raya Alternatif Sentul No.354, Sentul - Bogor..<br />
A/n Kristian</br>
082126999669 - 085717118745</br>
A/n Mario </br>
